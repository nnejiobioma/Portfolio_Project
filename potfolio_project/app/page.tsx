...
<div className="grid grid-cols-2 gap-20">
  <div className='leftSide p-8 my-20 items-center antialiased hover:subpixel-antialiase'>
   <div>
   <div className='text-xl' content-center><strong>Have you read the story
    The Tale of a Naughty Kitten by Lisa Spray</strong></div>
    <div className='content-center'>😺There once were two cats who lived across the road from the school in a
    small town near you. One of them, named Fluff, lived in a nice house and her
    best friend, Kat, lived next door in a rather old and ugly house. 
    The owners of the cats were best friends too. 
...
and her owners named her Beauty.</div>
<div className='content-center'>Everyone who saw her felt that her name fit her perfectly.
...
for them. She called them names and laughed at them. She told all her brothers and sisters
 to stay away from them because they were small and weak and dirty. She was especially mean to little Midnight.</div>

<div className='content-center'>This went on for several days until one day Fluff, her mother, overheard her teasing 
...
So you must be nice to her and her kittens if for no other reason than that,” her mother said.
 ...
 tells us to be nice to everyone when we can.”</div>

<div className='content-center'>Now Beauty was spoiled but she was not a bad kitten. When she heard what Kat had done for her 
...
found out that making others happy makes us happy too.😸</div>
   </div>
  </div>
  
  <div className='rightSide p-10 my-20 text-8xl font-bold flex flex-col space-y-5  animate-bounce w-20 h-20 '>
